...
public class M001_Initialize : Migration
{
    ...
    private void CreatePlayerConfigTable()
    {
        this.Create.Table("player_config")
            ...
            .WithColumn("nameplate_color_show_color").AsString()
            .WithColumn("nameplate_show_color_if_dead").AsString()
            .WithColumn("nameplate_use_category").AsString()
            .WithColumn("nameplate_use_custom_title").AsString()

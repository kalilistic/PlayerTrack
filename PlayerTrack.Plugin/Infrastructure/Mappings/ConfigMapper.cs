...
public static class ConfigMapper
{
    ...
    {
        Plugin.PluginLog.Verbose("Entering ConfigMapper.ToModel()");
    ...
    {
        Plugin.PluginLog.Verbose("Entering ConfigMapper.ToDTOs()");
        ...
        foreach (var property in typeof(PluginConfig).GetProperties(BindingFlags.Public | BindingFlags.Instance))
        {
            ...
            if (!string.IsNullOrEmpty(value))
                configEntryDTOs.Add(new ConfigEntryDTO { key = key, value = value, });
        }

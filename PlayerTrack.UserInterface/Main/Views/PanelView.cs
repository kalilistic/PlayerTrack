...
public class PanelView : PlayerTrackView
{
    ...
    public PanelView(string name, PluginConfig config, PlayerComponent playerComponent, AddPlayerComponent addPlayerComponent, LodestoneComponent lodestoneComponent, IMainPresenter presenter, ImGuiWindowFlags flags = ImGuiWindowFlags.None)
